...
public:
	...
	UPROPERTY(GlobalConfig, EditAnywhere, Category = "Editor | HttpGPT Chat",
		Meta = (DisplayName = "Custom System Context", EditCondition = "bUseCustomSystemContext"))
	FString CustomSystemContext;

	/* Directory to store images generated by HttpGPT Image Generator Editor Tool */
	UPROPERTY(GlobalConfig, EditAnywhere, Category = "Editor | HttpGPT Image Generator", Meta = (DisplayName = "Generated Images Directory"))
	...
	UFUNCTION(BlueprintPure, Category = "HttpGPT | Settings",
		meta = (HidePin = "Self", DefaultToSelf = "Self", DisplayName = "Get Common Options", CompactNodeTitle = "HttpGPT Common Options"))
	static FHttpGPTCommonOptions GetCommonOptions();

	UFUNCTION(BlueprintCallable, Category = "HttpGPT | Settings",
	...
	UFUNCTION(BlueprintPure, Category = "HttpGPT | Settings",
		meta = (HidePin = "Self", DefaultToSelf = "Self", DisplayName = "Get Image Options", CompactNodeTitle = "HttpGPT Image Options"))
